...
export default function HomePage() {
  ...
  const tiles = [
    { href: '/about', title: t.nav.about, body: { bn: 'জাতীয় কৃষক সংগঠন, তার নীতি এবং জনস্বার্থের উদ্দেশ্য।', en: 'National farmer organisation, principles, and public purpose.', hi: 'राष्ट्रीय किसान संगठन, उसके सिद्धांत और सार्वजनिक उद्देश्य।' } },
